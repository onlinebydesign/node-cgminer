...
CGMinerClient.prototype.connect = function () {
  ...
  return this.version()
    .then(function (version) {
      let versionForParse = version.CGMiner !== undefined ? version.CGMiner : version.API
      return require('./apis/parser').parse(versionForParse);
    })
  ...
  socket.on('connect', function () {
    ...
    socket.on('end', function () {
      ...
      try {
        ...
        // If no command reply set then just return the json object
